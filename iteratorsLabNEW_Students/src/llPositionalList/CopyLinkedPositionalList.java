...
public class CopyLinkedPositionalList<E> implements PositionalList<E> {
	...
	public CopyLinkedPositionalList() {
		this(new L2FIteratorMaker<E>());
		
	}
	
	public CopyLinkedPositionalList(PLIteratorMaker<E> maker) {
	...
	private class ElementIterator implements Iterator<E> { 
		Iterator<Position<E>> posIterator = iteratorMaker.makeIterator((PositionalList<E>) self);
	...
	private class PositionIterable implements Iterable<Position<E>> {
		...
		public Iterator<Position<E>> iterator() {
			return iteratorMaker.makeIterator((PositionalList<E>) self);
		} 
